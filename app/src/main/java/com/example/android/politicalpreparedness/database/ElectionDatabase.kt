...
abstract class ElectionDatabase: RoomDatabase() {
    ...
    companion object {
        ...
        @Volatile var SAVED_INSTANCE: ElectionDatabase? = null
        fun getSavedDatabaseInstance(context: Context): ElectionDatabase {
            synchronized(this) {
                var instance = SAVED_INSTANCE
                if (instance == null) {
                    instance = Room.databaseBuilder(
                            context.applicationContext,
                            ElectionDatabase::class.java,
                            "election_saved_database"
                    )
                            .fallbackToDestructiveMigration()
                            .build()
